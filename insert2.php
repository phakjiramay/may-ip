...
<body>
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="id" name="id" type="text" placeholder="" class="form-control input-md" readonly
                        value="<?=$data['fm_id'];?>">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="Size" name="Size" type="text" placeholder="" class="form-control input-md" required=""
                        value="">
    ...
    <?php
	 ...
	 if (isset ($_POST ['Submit'])){
		 ...
		 $sql = "INSERT INTO `pdfemale` VALUES ('".$_POST['p_id']."','".$_POST['p_name']."','".$_POST['p_color']."', '".$_POST['p_brand']."','".$_POST['p_detail']."', '".$_POST['p_price']."');";
		 //var_dump($sql); exit;
		 mysqli_query($conn,$sql) or die ("เพิ่มข้อมูลไม่ได้");
		 
		 copy($_FILES['img']['p_img'],"img/".$_POST['id'].".jpg");  //codeเพิ่มรูป 
