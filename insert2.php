...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="brand" name="brand" type="text" placeholder="" class="form-control input-md" required="" value="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="price" name="price" type="text" placeholder="" class="form-control input-md" required="" value="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="Size" name="Size" type="text" placeholder="" class="form-control input-md" required="" value="">
