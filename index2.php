                        ...
                        <div class="col-sm-8 offset-sm-2 text-center">
                            <div class="row">
                                <div class="owl-carousel2">
                                    <div class="item">
                                        <div class="col">
                                            <h3><a href="#">ลด 25% สำหรับสมาชิกทุกท่าน</a></h3>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="col">
                                            <h3><a href="#">ลดราคาครั้งใหญ่ที่สุดของเรา แต่ลด 50% สำหรับรองเท้ากีฬา
                                                    เพื่อออกกำลังกาย</a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 offset-sm-3 text-center slider-text">
                                    <div class="slider-text-inner">
                                        <div class="desc">
                                            <h1 class="head-1">ซื้อ-ขาย</h1>
                                            <h2 class="head-2">ของแบรนด์เนมของแท้</h2>
                                            <h2 class="head-3"></h2>
                                            <p class="category"><span>รับประกันของแท้ 100%</span></p>
                                            <p><a href="#" class="btn btn-primary">ช้อป รองเท้า</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h2 class="intro">เกี่ยวกับสินค้า</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6 text-center">
                        <div class="featured">
                            <a href="#" class="featured-img" style="background-image: url(images/21.jpeg);"></a>
                            <div class="desc">
                                <h2><a href="#">รองเท้ากีฬาผู้ชาย</a></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 text-center">
                        <div class="featured">
                            <a href="#" class="featured-img" style="background-image: url(images/31.jpg);"></a>
                            <div class="desc">
                                <h2><a href="#">รองเท้ากีฬาผู้หญิง</a></h2>
                            </div>
                        </div>
                    </div>
                </div>
